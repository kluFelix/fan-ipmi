...
int main() {
    ...
    runCommand("sensor thresh CPU_FAN2 lower 200 300 300");
    runCommand("sensor thresh SYS_FAN1 lower 200 300 300");
    runCommand("sensor thresh SYS_FAN2 lower 100 200 200");
